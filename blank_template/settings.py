...
# SECURITY WARNING: keep the secret key usedin production secret!
...
MIDDLEWARE = [
    ...
    'django.contrib.sessions.middleware.SessionMiddleware'Django settings for blank_template project.
...
# SECURITY WARNING: keep the secret key used in production secret!SECRET_KEY = env('SECRET_KEY')
...
def get_db_config(environ_var):
    ...
    if options.get('ENGINE') != 'django.db.backends.sqlite3':
        return optionsif not options['NAME'] == ':memory:' and not os.path.isabs(options['NAME']):
